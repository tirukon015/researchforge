...
_None yet. Papers will be added in Milestone 3, when PDF ingestion is built._

| File | Title | Authors | Year | Source URL | Licence |
|---|---|---|---|---|---|
| _(empty)_ | | | | | |

## Why this file exists

Reproducibility and academic integrity. Anyone reading this repository must be
able to see exactly which real documents the system was tested against, and
confirm they were legally obtained.
